        ...
        <div className="land-popup-modern">
          ...
          <div className="popup-info">
            ...
            <div className="popup-row">
              ...
              <span className="popup-label">เจ้าของ</span>
              <span className="popup-value">{selectedLand.owner}</span>
            </div>

            <div className="popup-row">
              <div className="popup-icon"><FaFileAlt /></div>
              <span className="popup-label">โฉนด</span>
              <span className="popup-value">{selectedLand.deed}</span>
            </div>
          </div>
